...
/*
 * ZTE_JIA_20140312 jia.jia
 */
#if 0
	// Do nothing here
#else
#if defined(CONFIG_MACH_WARPLTE)
	REGULATOR_SUPPLY("cam_vdig",		"4-0036"), // CONFIG_OV8825_BAYER/CONFIG_OV8835_BAYER
	REGULATOR_SUPPLY("cam_vdig",		"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_STORMER)
	REGULATOR_SUPPLY("cam_vdig",		"4-0036"), // CONFIG_OV8835_BAYER
	REGULATOR_SUPPLY("cam_vdig",		"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_COEUS)
	/*
	 * Add camera driver for P893A21(CONFIG_MACH_COEUS) by caidezun 20140517
	 * L11 is shared with other modules, so camera does not need to set it.
	 *
	 */
	// Do nothing here
#elif defined(CONFIG_MACH_NEX)
	/*
	 * Add camera driver for N800(CONFIG_MACH_NEX) by zhaishichang 20140612
	 * L11 is shared with other modules, so camera does not need to set it.
	 *
	 */
	// Do nothing here
...
#else
#if defined(CONFIG_MACH_WARPLTE)
	REGULATOR_SUPPLY("cam_vio",		"4-0036"), // CONFIG_OV8825_BAYER/CONFIG_OV8835_BAYER
	REGULATOR_SUPPLY("cam_vio",		"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_STORMER)
	REGULATOR_SUPPLY("cam_vio",		"4-0036"), // CONFIG_OV8835_BAYER
	REGULATOR_SUPPLY("cam_vio",		"4-0010"), // CONFIG_OV9740
#endif /* defined(CONFIG_MACH_WARPLTE) */
#endif
 ...
 * ZTE_JIA_20140313 jia.jia
 *
 * DISUSED here due to 'L11' shared with other device
 *
 * refer to 'msm_8930_cam_vreg'
 * refer to 'ov8825_veg_seq'/'ov8835_veg_seq'/'ov9740_veg_seq'
 */
#if 1
	RPM_LDO(L11,	 1, 1, 0, 1800000, 1800000, "8038_s4", 10000, 10000),
#else
#if defined(CONFIG_MACH_WARPLTE)
	RPM_LDO(L11,	 1, 1, 0, 1500000, 1800000, "8038_s4", 10000, 10000), // CONFIG_OV8825_BAYER/CONFIG_OV8835_BAYER/CONFIG_OV9740's DVDD
#elif defined(CONFIG_MACH_STORMER)
	RPM_LDO(L11,	 1, 1, 0, 1200000, 1800000, "8038_s4", 10000, 10000), // CONFIG_OV8835_BAYER/CONFIG_OV9740's DVDD/IOVDD
#endif /* defined(CONFIG_MACH_WARPLTE) */
#endif
