...
/*
 * deleted by caidezun for hi542 reg address 20140517
 * deleted by zhaishichang for hi542 reg address 20140612
 */
#if defined(CONFIG_MACH_COEUS)
	// Do nothing here
#elif defined(CONFIG_MACH_NEX)
	// Do nothing here
#else
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0020"),
#endif /* defined(CONFIG_MACH_COEUS) */
 ...
 */
	...
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0036"), // CONFIG_OV8825_BAYER/CONFIG_OV8835_BAYER
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_STORMER)
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0036"), // CONFIG_OV8835_BAYER
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_COEUS)
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0020"), // CONFIG_HI542_BAYER
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0010"), // CONFIG_OV9740
#elif defined(CONFIG_MACH_NEX)
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0020"), // CONFIG_HI542_BAYER
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0010"), // CONFIG_OV9740
