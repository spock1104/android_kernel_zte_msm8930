...
#if defined(CONFIG_OV8825_BAYER) || defined(CONFIG_OV8835_BAYER) || defined(CONFIG_OV9740)
...
#endif /* defined(CONFIG_OV8825_BAYER) || defined(CONFIG_OV8835_BAYER) || defined(CONFIG_OV9740) */
...
static struct msm_camera_sensor_flash_src msm_flash_src_led __attribute__((unused)) = {
...
#if defined(CONFIG_OV8825_BAYER) || defined(CONFIG_OV8835_BAYER)
...
#endif /* defined(CONFIG_OV8825_BAYER) || defined(CONFIG_OV8835_BAYER) */
...
static struct msm_camera_gpio_conf msm_8930_evt_back_cam_gpio_conf __attribute__((unused)) = {
	.cam_gpiomux_conf_tbl = msm8930_evt_cam_2d_configs,
	.cam_gpiomux_conf_tbl_size = ARRAY_SIZE(msm8930_evt_cam_2d_configs),
	.cam_gpio_common_tbl = msm8930_evt_common_cam_gpio,
	.cam_gpio_common_tbl_size = ARRAY_SIZE(msm8930_evt_common_cam_gpio),
...
static struct i2c_board_info msm_act_main_cam_i2c_info_ov8825 = {
	I2C_BOARD_INFO("msm_actuator", 0x6C>>2),
};
#endif /* defined(CONFIG_OV8825_BAYER) */

#if defined(CONFIG_OV8835_BAYER)
static struct i2c_board_info msm_act_main_cam_i2c_info_ov8835 = {
...
#if defined(CONFIG_OV8825_BAYER)
static struct msm_actuator_info msm_act_main_cam_3_info_ov8825 = {
	.board_info     = &msm_act_main_cam_i2c_info_ov8825,
...
#if defined(CONFIG_OV8835_BAYER)
static struct msm_actuator_info msm_act_main_cam_3_info_ov8835 = {
	.board_info     = &msm_act_main_cam_i2c_info_ov8835,
	.cam_name       = MSM_ACTUATOR_MAIN_CAM_3,
	.bus_id         = MSM_8930_GSBI4_QUP_I2C_BUS_ID,
	.vcm_pwd        = 15,
	.vcm_enable     = 1,
...
static struct msm_camera_sensor_info msm_camera_sensor_ov8825_data = {
	...
	.actuator_info = &msm_act_main_cam_3_info_ov8825,
};
#else
static struct msm_camera_sensor_info msm_camera_sensor_ov8825_data = {
	.sensor_name = "ov8825",
...
static struct msm_camera_sensor_info msm_camera_sensor_ov8835_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &msm_act_main_cam_3_info_ov8835,
};
#endif /* defined(CONFIG_OV8835_BAYER) */
