...
static struct pm8xxx_mpp_init pm8038_mpps[] __initdata = {
	PM8038_MPP_INIT(3,SINK, PM8XXX_MPP_CS_OUT_5MA, CS_CTRL_DISABLE), //zte copy from JB
};
...
static int pm8921_therm_mitigation[] = {
	...
	|| defined(CONFIG_MACH_HERA)	|| defined(CONFIG_MACH_OCEANUS)|| defined(CONFIG_MACH_STORMER)
...
#if defined(CONFIG_MACH_STORMER)//P893S05
