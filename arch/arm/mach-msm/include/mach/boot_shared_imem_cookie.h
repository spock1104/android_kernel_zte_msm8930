...
#define SCL_TZ_CODE_BASE 0x2A000000
#define SCL_TZ_TOTAL_SIZE 0x003F000
#define SHARED_IMEM_BASE (SCL_TZ_CODE_BASE + SCL_TZ_TOTAL_SIZE)
...
__packed struct boot_shared_imem_cookie_type
{
  ...
  //zte PM( ap sleep/awake time acount)  20140513-begin  (get modem sleep/wake time acount)
