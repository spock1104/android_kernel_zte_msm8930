...
#if defined (CONFIG_MACH_NEX)||defined(CONFIG_MACH_STORMER)//N800 N9520
...
#define BATTERY_SWITCH_GPIO		PM8038_GPIO_PM_TO_SYS(1)

static struct zte_misc_platform_data gpio_switchoff_pdata = {
	.ftl_gpio = BATTERY_SWITCH_GPIO, //battery switch gpio num
};
...
static struct platform_device zte_misc_device = {
	...
	.id	= -1,
	.dev		= {
		.platform_data  = &gpio_switchoff_pdata,
		},
};
#endif
//zte PM (hall)
#ifdef CONFIG_ZTE_HALL_AVAILABLE
    #if defined(CONFIG_MACH_STORMER)
    #define HALL_DETECT_GPIO		90
    #elif defined(CONFIG_MACH_PRMTHUS)
    #define HALL_DETECT_GPIO		35
	#else
    #define HALL_DETECT_GPIO		90 //set 90 as the default HALL GPIO
    #endif

static struct zte_hall_platform_data gpio_hall_pdata = {
	.hall_gpio = HALL_DETECT_GPIO, //hall  gpio num
};

static struct platform_device zte_hall_device = {
	.name	=  "zte-hall",
	.id	= -1,
	.dev		= {
		.platform_data  = &gpio_hall_pdata,
		},
};
#endif
...
static struct i2c_board_info msm_i2c_gsbi12_sensors_info[] = {
	...
	#endif
	//---
#ifdef CONFIG_SENSORS_KXTIK //xym
	{ 
...
#endif
#ifdef CONFIG_SENSORS_ST_LIS3DHTR //xym
	{ 
...
MACHINE_START(RHEA, "ZTE MSM8930 RHEA")
	.map_io = msm8930_map_io,
	.reserve = msm8930_reserve,
	.init_irq = msm8930_init_irq,
	.handle_irq = gic_handle_irq,
