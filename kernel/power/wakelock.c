...
//zte PM (dump wakelock analysis 20140514)
...
enum {
	...
	DEBUG_WAKELOCK_ZTE = 1U << 5,//zte PM (dump wakelock analysis 20140514)
};
...
//zte PM (dump wakelock analysis 20140514)   //cat debug_mask=7
...
//zte PM (dump wakelock analysis 20140514)   //recorder wakelock if this one can last more than 2 mins
#ifdef DUMP_WAKELOCK
