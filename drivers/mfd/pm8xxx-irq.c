...
#ifdef CONFIG_PM
	pm8xxx_irq_chip_ptr = chip; //zte PM 20140522 irq
#endif
	chip->dev = dev;
	chip->devirq = devirq;
...
#ifdef CONFIG_PM
	register_syscore_ops(&pm8xxx_syscore_ops);//zte PM 20140522 irq
#endif
	return chip;
}
