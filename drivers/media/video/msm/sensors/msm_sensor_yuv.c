...
/*
 * Created by ZTE_JIA_20140324 jia.jia
 *
 * Refer to 'msm_sensor_bayer_power_up'/'msm_sensor_bayer_power_down'
 * in 'msm_sensor_bayer.c' for power sequence
 */
	...
	for (index--; index >= 0; index--) {
		...
		case CONFIG_CLK:
			msm_cam_clk_enable(&s_ctrl->sensor_i2c_client->client->
				dev, cam_8960_clk_info, s_ctrl->cam_clk,
