...
/*
 * Created by caidezun to add camera driver for P893A21_KK 20140517
 */
...
static struct i2c_driver hi542_i2c_driver_bayer = {
...
static int32_t hi542_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	int32_t rc = 0;
	uint16_t chipid = 0;
...
static struct msm_sensor_reg_t hi542_sensor_reg = {
...
static struct msm_sensor_ctrl_t hi542_s_ctrl = {
	...
	.msm_sensor_reg = &hi542_sensor_reg,
};
