...
/*
 * Revert 'Support for camera actuator of Rohm bu64291'
 *
 * See 'vendor/qcom/proprietary/mm-camera/server/hardware/actuator/0208/8960/af_main_cam_2.h'
 * i.e., data is preprocessed in vendor.
 *
 * by ZTE_JIA_20140506 jia.jia
 */
...
/*
 * Fix compiling warning by ZTE_JIA_20140313 jia.jia
 */
#if 0
	int32_t num_steps = move_params->num_steps;
#endif
