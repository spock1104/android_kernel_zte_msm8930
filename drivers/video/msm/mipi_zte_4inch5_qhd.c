...
static char boe_gen_write_022[]={0xC1,0x55};//77
...
static char boe_gen_write_034[]={0xC5,0x04,0x58};//f8
...
static char boe_gen_write_44[]={0x44,0x01,0xff};//TE relatived
...
static char yushun_qhd_otm9608a_1P_11[]={0xC1,0x55};//55//77
...
static char yushun_qhd_otm9608a_2P_17[]={0xC5,0x04,0x5c,0x01,0x00,0x71,0xb1,0x83};//0xac
...
static char yushun_qhd_otm9608a_44[]={0x44,0x01,0xff};//TE relatived
...
//3.tianma nt35516
static char tianma_nt35516_para03[]={0xB6,0x05};//0B
...
static char tianma_nt35516_para18[]={0xB7,0x24}; //34->24
...
static char tianma_nt35516_para22[]={0xB9,0x34};//34//24
static char tianma_nt35516_para23[]={0xB4,0x08};
static char tianma_nt35516_para24[]={0xBA,0x14};//24->14//24//14
static char tianma_nt35516_para27[]={0xBE,0x4A}; //3E->4A
...
static char tianma_nt35516_para25[]={0xBC,0x00,0x50,0x00}; //78->50
static char tianma_nt35516_para26[]={0xBD,0x00,0x50,0x00}; //78->50
...
//3
static char new_glass_tianma_nt35516_para04[]={0xB6,0x05};
static char new_glass_tianma_nt35516_para07[]={0xBA,0x05};	 
static char new_glass_tianma_nt35516_para13[]={0x3A,0x77};
static char new_glass_tianma_nt35516_para14[]={0x36,0x00};
static char new_glass_tianma_nt35516_para16[]={0xB0,0x0A};
static char new_glass_tianma_nt35516_para17[]={0xB6,0x54};
static char new_glass_tianma_nt35516_para18[]={0xB1,0x0A};
static char new_glass_tianma_nt35516_para19[]={0xB7,0x34};
static char new_glass_tianma_nt35516_para20[]={0xB2,0x00};
static char new_glass_tianma_nt35516_para21[]={0xB8,0x30};
static char new_glass_tianma_nt35516_para22[]={0xB3,0x0D};
static char new_glass_tianma_nt35516_para23[]={0xB9,0x24};
static char new_glass_tianma_nt35516_para24[]={0xB4,0x08};
static char new_glass_tianma_nt35516_para25[]={0xBA,0x14};
static char new_glass_tianma_nt35516_para28[]={0xBE,0x2E};
static char new_glass_tianma_nt35516_para52[]={0xC2,0x00}; 
static char new_glass_tianma_nt35516_para03[]={0xB1,0xFC,0x00,0x80};
static char new_glass_tianma_nt35516_para05[]={0xB7,0x72,0x72};
static char new_glass_tianma_nt35516_para08[]={0xBC,0x00,0x00,0x00};
static char new_glass_tianma_nt35516_para09[]={0xBB,0x53,0x03,0x53};
static char new_glass_tianma_nt35516_para12[]={0xE0,0x00,0x03};
static char new_glass_tianma_nt35516_para26[]={0xBC,0x00,0x78,0x00};
static char new_glass_tianma_nt35516_para27[]={0xBD,0x00,0x78,0x00};
static char new_glass_tianma_nt35516_para02[]={0xB0,0x00,0x05,0x02,0x05,0x02}; 
static char new_glass_tianma_nt35516_para06[]={0xB8,0x01,0x04,0x04,0x04};
static char new_glass_tianma_nt35516_para15[]={0xF0,0x55,0xAA,0x52,0x08,0x01}; 
static char new_glass_tianma_nt35516_para32[]={0xD4,0x03,0xDE,0x03,0xF8};	
static char new_glass_tianma_nt35516_para36[]={0xD8,0x03,0xDE,0x03,0xF8};
static char new_glass_tianma_nt35516_para40[]={0xDF,0x03,0xDE,0x03,0xF8};
static char new_glass_tianma_nt35516_para44[]={0xE3,0x03,0xDE,0x03,0xF8};
static char new_glass_tianma_nt35516_para48[]={0xE7,0x03,0xDE,0x03,0xF8};   
static char new_glass_tianma_nt35516_para01[]={0xF0,0x55,0xAA,0x52,0x08,0x00};
static char new_glass_tianma_nt35516_para10[]={0xC9,0x41,0x06,0x0d,0x3A,0x17,0x00};
static char new_glass_tianma_nt35516_para11[]={0xCA,0x00,0xE4,0xE4,0xE4,0xE4,0xE4,0xE4,0x02,0x02,0x00,0x01};
static char new_glass_tianma_nt35516_para29[]={0xD1,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para30[]={0xD2,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para31[]={0xD3,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};
static char new_glass_tianma_nt35516_para33[]={0xD5,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para34[]={0xD6,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para35[]={0xD7,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};
static char new_glass_tianma_nt35516_para37[]={0xD9,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para38[]={0xDD,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para39[]={0xDE,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};
static char new_glass_tianma_nt35516_para41[]={0xE0,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para42[]={0xE1,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para43[]={0xE2,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};
static char new_glass_tianma_nt35516_para45[]={0xE4,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para46[]={0xE5,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para47[]={0xE6,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};
static char new_glass_tianma_nt35516_para49[]={0xE8,0x00,0x00,0x00,0x1D,0x00,0x49,0x00,0x73,0x00,0x95,0x00,0xCA,0x00,0xFB,0x01,0x31};
static char new_glass_tianma_nt35516_para50[]={0xE9,0x01,0x56,0x01,0x90,0x01,0xBE,0x02,0x08,0x02,0x43,0x02,0x46,0x02,0x7A,0x02,0xB2};
static char new_glass_tianma_nt35516_para51[]={0xEA,0x02,0xD5,0x03,0x05,0x03,0x2C,0x03,0x46,0x03,0x65,0x03,0xA3,0x03,0xB2,0x03,0xC7};

static struct dsi_cmd_desc new_glass_tianma_nt35516_video_on_cmds[] = 
{
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para01), new_glass_tianma_nt35516_para01}, 
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para02), new_glass_tianma_nt35516_para02},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para03), new_glass_tianma_nt35516_para03},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para04), new_glass_tianma_nt35516_para04},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para05), new_glass_tianma_nt35516_para05},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para06), new_glass_tianma_nt35516_para06},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para07), new_glass_tianma_nt35516_para07},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para08), new_glass_tianma_nt35516_para08},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para09), new_glass_tianma_nt35516_para09},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para10), new_glass_tianma_nt35516_para10},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para11), new_glass_tianma_nt35516_para11},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para12), new_glass_tianma_nt35516_para12},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para13), new_glass_tianma_nt35516_para13},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para14), new_glass_tianma_nt35516_para14},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para15), new_glass_tianma_nt35516_para15},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para16), new_glass_tianma_nt35516_para16},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para17), new_glass_tianma_nt35516_para17},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para18), new_glass_tianma_nt35516_para18},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para19), new_glass_tianma_nt35516_para19},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para20), new_glass_tianma_nt35516_para20},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para21), new_glass_tianma_nt35516_para21},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para22), new_glass_tianma_nt35516_para22},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para23), new_glass_tianma_nt35516_para23},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para24), new_glass_tianma_nt35516_para24},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para25), new_glass_tianma_nt35516_para25},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para26), new_glass_tianma_nt35516_para26},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para27), new_glass_tianma_nt35516_para27},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para28), new_glass_tianma_nt35516_para28},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para29), new_glass_tianma_nt35516_para29},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para30), new_glass_tianma_nt35516_para30},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para31), new_glass_tianma_nt35516_para31},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para32), new_glass_tianma_nt35516_para32},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para33), new_glass_tianma_nt35516_para33},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para34), new_glass_tianma_nt35516_para34},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para35), new_glass_tianma_nt35516_para35},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para36), new_glass_tianma_nt35516_para36},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para37), new_glass_tianma_nt35516_para37},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para38), new_glass_tianma_nt35516_para38},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para39), new_glass_tianma_nt35516_para39},	
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para40), new_glass_tianma_nt35516_para40},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para41), new_glass_tianma_nt35516_para41},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para42), new_glass_tianma_nt35516_para42},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para43), new_glass_tianma_nt35516_para43},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para44), new_glass_tianma_nt35516_para44},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para45), new_glass_tianma_nt35516_para45},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para46), new_glass_tianma_nt35516_para46},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para47), new_glass_tianma_nt35516_para47},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para48), new_glass_tianma_nt35516_para48},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para49), new_glass_tianma_nt35516_para49},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para50), new_glass_tianma_nt35516_para50},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para51), new_glass_tianma_nt35516_para51},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(new_glass_tianma_nt35516_para52), new_glass_tianma_nt35516_para52},
...
static char OTM9608_CMI_022[]={0xC1,0x55};//0x55//66
...
static char OTM9608_CMI_034[]={0xC5,0x04,0x58};//f8
...
static char OTM9608_CMI_44[]={0x44,0x01,0xff};//TE relatived
...
u32 mipi_get_panle_vol_flag_NT35516(uint32 gpio_num)
{
	u32 panelId;
	int rc, val = -1;
	...
	if (!rc) 
	{
		printk("%s:yanwei, lcd request id_pin , rc=%d\n",__func__,rc);
		gpio_tlmm_config(GPIO_CFG(gpio_num, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA), GPIO_CFG_ENABLE);
		...
		printk("%s:yanwei 2 lcd request id_pin , val=%d\n",__func__,val);
	switch(val)
	{
		case 1:
			panelId = (u32)LCD_PANEL_4P5_TIANMA_NT35516_QHD_NEW_GLASS;
			break;
		case 0:
			panelId = (u32)LCD_PANEL_4P5_TIANMA_NT35516_QHD;
			break;
		default:
			panelId = (u32)LCD_PANEL_NOPANEL;
			break;
...
static uint32 mipi_get_icpanleid(struct msm_fb_data_type *mfd )
{
	...
	switch(temp)
	{
		case OTM9608A:		 
			...
			break;
		case NT35516:
			panelId = mipi_get_panle_vol_flag_NT35516(GPIO_LCD_ID);			
			break;
		default:
...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	switch(LcdPanleID){		
		...
		case (u32)LCD_PANEL_4P5_TIANMA_NT35516_QHD:
				...
				break;
		case (u32)LCD_PANEL_4P5_TIANMA_NT35516_QHD_NEW_GLASS:
				mipi_dsi_cmds_tx(&lead_tx_buf, new_glass_tianma_nt35516_video_on_cmds, ARRAY_SIZE(new_glass_tianma_nt35516_video_on_cmds));
				printk("tianma_nt35516_video_on_cmds_new_glass init ok !!\n");
				break;					
...
{	
	...
	if (pdev->id == 0) 
		return 0;
	if (LcdPanleID ==LCD_PANEL_4P5_BOE_OTM9608A_QHD || LcdPanleID == LCD_PANEL_4P5_YUSHUN_OTM9608A_QHD || LcdPanleID == LCD_PANEL_4P5_LEAD_CMI_OTM9608A_QHD)
