...
//back 1540
		...
		/* timing */
		{0x7b, 0x1c, 0x14, 0x00, 0x31, 0x37, 0x19, 0x20,
		0x21, 0x03, 0x04, 0xa0},
		/* phy ctrl */
		{0x5f, 0x00, 0x00, 0x10},
		/* strength */
		{0xff, 0x00, 0x06, 0x00},
		/* pll control */
		{0x01, 0xbf, 0x31, 0xda, 0x00, 0x5f, 0x48, 0x63,
...
static int __init mipi_video_novatek_qhd_pt_init(void)
{
	...
	pinfo.wait_cycle = 0;
	pinfo.bpp = 24;
	pinfo.lcdc.h_back_porch =100;//60;// 80;
	pinfo.lcdc.h_front_porch =100;//60;// 24;
