...
static struct mipi_dsi_phy_ctrl dsi_video_mode_phy_db_for_truly_405={
	...
	{0xff, 0x00, 0x06, 0x00},
	/* pll control */
	{0x0, 0x94, 0x31, 0xda, 0x00, 0x50, 0x48, 0x63,
	0x30, 0x07, 0x03,//0x41, 0x0f, 0x01,
	0x00, 0x14, 0x03, 0x00, 0x02, 0x00, 0x20, 0x00, 0x01 },
	//63
...
#if 0
static struct mipi_dsi_phy_ctrl * dsi_video_mode_phy_dbs_for_truly_405[] = {
	&dsi_video_mode_phy_db_for_truly_405,
	&dsi_video_mode_phy_db_45,
	&dsi_video_mode_phy_db_30
};
#endif
...
static int __init mipi_video_lead_wvga_pt_init(void)
{
	...
	pinfo.lcdc.v_pulse_width = 10;
		...
		{
			pinfo.mipi.dsi_phy_db = &dsi_video_mode_phy_db_for_truly;// dsi_video_mode_phy_dbs_for_truly;
		...
		{
		#ifdef CONFIG_MACH_NEX   //n800 405m
			pinfo.mipi.dsi_phy_db = &dsi_video_mode_phy_db_for_truly_405;//dsi_video_mode_phy_dbs_for_truly_405;
			//pinfo.mipi.dsi_phy_db_count = ARRAY_SIZE(dsi_video_mode_phy_dbs_for_truly_405);
			printk(KERN_ERR "raplace=%d\n", LcdPanleID);	
		#else
			pinfo.mipi.dsi_phy_db = &dsi_video_mode_phy_db_for_truly;//dsi_video_mode_phy_dbs_for_truly;
			//pinfo.mipi.dsi_phy_db_count = ARRAY_SIZE(dsi_video_mode_phy_dbs_for_truly);
