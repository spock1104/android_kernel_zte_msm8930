	...
	case FB_BLANK_UNBLANK:
		if (!mfd->panel_power_on) {
			...
			if (ret == 0) {
				...
				{
					//printk("LCD enter ftm mode, set the level\n");
					msm_fb_set_backlight(mfd, 5);//should remove it later
				}
				else
				{
...
static int msm_fb_lcd_read_proc(char *page, char **start, off_t off, int count, int *eof, void *data)
{
	...
	switch(LcdPanleID)
	{
		...
		case LCD_PANEL_4P0_OTM_8009_CMI:
			...
			break;
		case LCD_PANEL_4P0_OTM8018_BOE:
			strcpy(module_name,"zteBOE(OTM8018)_480*800_4.0Inch");
			break;
		case LCD_PANEL_4P0_OTM8018_TM_TN:
			strcpy(module_name,"zteTM_TN(OTM8018)_480*800_4.0Inch");
			break;
		case LCD_PANEL_4P0_NT35512_HSD_TN:
			strcpy(module_name,"zteHSD_TN(NT35512)_480*800_4.0Inch");
			break;
		
		case LCD_PANEL_4P5_OTM1280_OT_CMI:
			strcpy(module_name,"zteCMI(OTM1281)_720*1280_4.5Inch");
			break;
		case LCD_PANEL_4P5_OTM1281_OT_TRULY:
			strcpy(module_name,"zteTRULY(OTM1281)AUO_720*1280_4.5Inch");
			break;
		case LCD_PANEL_4P5_NT35590_AUO_LEAD:
			strcpy(module_name,"zteAUO(NT35590)_720*1280_4.5Inch");
			break;
		case LCD_PANEL_4P5_NT35590_TIANMA:
			strcpy(module_name,"zteTianMa(NT35590)_720*1280_4.5Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_AUO_LEAD:
			strcpy(module_name,"zteLEAD(OTM1283A)AUO_720*1280_5.7Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_BOE_BOE:
			strcpy(module_name,"zteBOE(OTM1283A)BOE_720*1280_5.7Inch");
			break;
		case LCD_PANEL_5P7_OTM1283A_CPT:
			strcpy(module_name,"zteLEAD(OTM1283A)CPT_720*1280_5.7Inch");
			break;
		...
		case LCD_PANEL_4P5_YUSHUN_OTM9608A_QHD:
			strcpy(module_name,"zteYS(OTM9608A)LG_540*960_4.5Inch");
			break;
		...
		case LCD_PANEL_4P5_LEAD_CMI_OTM9608A_QHD:
			strcpy(module_name,"zteLEAD(OTM9608A)CMI_540*960_4.5Inch");
			break;
		case LCD_PANEL_4P5_TIANMA_NT35516_QHD_NEW_GLASS:
			strcpy(module_name,"zteTIANMA(NT35516)NEW_540*960_4.5Inch");
			break;
		case LCD_PANEL_MAX:
