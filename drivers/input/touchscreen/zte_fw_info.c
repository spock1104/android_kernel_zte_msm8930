...
int zte_fw_info_show(char *page, int len)
{
	...
	len += sprintf(page + len, "\t\t\t\t S2202+ECW : 04\n");  //EELY
...
*/
int zte_fw_latest(int ver)
{
	if(ver==-1)
		return 2;//can't get the fw ver
	...
	case 0x55://laibao  ft
		return ((g_zte_fw_ver>=0x11)?1:0); break;		
	case 0x5A:// TRULY  ft
	...
	case '2'://Truly sy
		return ((g_zte_fw_ver>=0x3035)?1:0); break;
	case '3'://Success sy
		return ((g_zte_fw_ver>=0x3042)?1:0); break;
	case 0x55://laibao  ft
		return ((g_zte_fw_ver>=0x11)?1:0); break;		
	default:
		return 2;	break;//unknown module
